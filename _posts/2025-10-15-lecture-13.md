...
**_How it works:_** A kernel (a small matrix of weights, e.g., $w, x, y, z$) acts as a sliding filter.
...
Multiple _feature detectors_ (kernels) can be applied in parallel to the same input image.  
