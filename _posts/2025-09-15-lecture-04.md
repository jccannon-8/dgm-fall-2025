...
- **1838** — Verhulst: introduces the _logistic function_ (population growth).
- **1943** — McCulloch & Pitts: logic neurons (no learning).
- **1944** — Berkson: introduces the _logit_.
...
- **1986** — Rumelhart, Hinton & Williams: backpropagation + sigmoids.
  - _Can be seen as “solve the 1969 problem by stacking the 1958 model → MLE by gradient ascent / chain rule.”_
...
_Note: This lecture provides the fundamental building blocks that we'll use throughout the course. Make sure you understand the geometric intuition and mathematical formulation before moving to more complex architectures._
Only basic.
