...
<figure id="pgm-structure" class="l-body-outset">
  <div class="row">
    <div class="col" style="width: 100%; float: left;">
      <img src="{{ '/assets/img/notes/lecture-22/1.2-pgm.png' | relative_url }}" />
      <figcaption>
        <strong>Figure.</strong>
        Directed PGM for autoregressive language modeling. Each token \(X_t\) is conditioned on all previous tokens \(X_{<t}\), forming a chain structure where information flows left to right.
      </figcaption>
    </div>
  </div>
</figure>
